...
class FeedbacksServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
FeedbacksServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "factory", "default", "default", "1.0");
FeedbacksServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "persistence", "memory", "*", "1.0");
FeedbacksServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "persistence", "file", "*", "1.0");
FeedbacksServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "persistence", "mongodb", "*", "1.0");
FeedbacksServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "controller", "default", "*", "1.0");
FeedbacksServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "service", "seneca", "*", "1.0");
FeedbacksServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-feedbacks", "service", "http", "*", "1.0");
