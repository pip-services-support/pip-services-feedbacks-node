...
class FeedbacksCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetFeedbacksCommand() {
        return new pip_services3_commons_node_2.Command("get_feedbacks", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetFeedbackByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_feedback_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('feedback_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeSendFeedbackCommand() {
        return new pip_services3_commons_node_2.Command("send_feedback", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeReplyFeedbackCommand() {
        return new pip_services3_commons_node_2.Command("reply_feedback", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('feedback_id', pip_services3_commons_node_6.TypeCode.String)
            .withRequiredProperty('reply', pip_services3_commons_node_6.TypeCode.String)
    ...
    makeDeleteFeedbackByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_feedback_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('feedback_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let feedbackId = args.getAsNullableString("feedback_id");
